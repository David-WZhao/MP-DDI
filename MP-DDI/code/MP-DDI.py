...
#drug-protein-side effect-disease
import time
import xlwt
...
def train_and_evaluate(DSAtrain, DSAvalid, DSAtest,drug_feat,protein_feat,args,k):
    ...
    all_meta_paths = [[('dd', 'dd'), ('dap', 'pad'),('dcp', 'pcd'),('dep', 'ped'),('dtp', 'ptd'),('dd','dap'),('dd','dcp'),('dd','dep'),('dd','dtp'),('dd', 'dd', 'dd'),('dd', 'dap', 'pad'),('dd', 'dcp', 'pcd'),('dd', 'dep', 'ped'),('dd', 'dtp', 'ptd'),('dd', 'dd', 'dap'),('dd', 'dd', 'dcp'),('dd', 'dd', 'dep'),('dd', 'dd', 'dtp')],
                      [('pad', 'dd'),('pcd', 'dd'),('ped', 'dd'),('ptd', 'dd'), ('pp', 'pp'), ('pad', 'dap'),('pcd', 'dcp'),('ped', 'dep'),('ptd', 'dtp'), ('pp', 'pp', 'pad'),('pp', 'pp', 'pcd'),('pp', 'pp', 'ped'),('pp', 'pp', 'ptd'), ('pp', 'pp', 'pp'), ('pp', 'pad', 'dap'),('pp', 'pcd', 'dcp'),('pp', 'ped', 'dep'),('pp', 'ptd', 'dtp')]]
...
def main(args):
    ...
    for i in whole_positive_index:
        ...
        data_set[count][2] = 1
        count += 1
    #将抽出来的那部分负样本按[i,j,lab]的形式存入data_set
